...
export const translations: Record<Language, TranslationStructure> = {
  ko: {
    ...
    toolsList: [
      ...
      },
      {
        ...
        title: "환율 / 환전 계산기 (Currency Converter)",
        desc: "제공 환율 기준 주요 통화(USD, JPY, EUR, KRW) 금액 변환",
        category: "금융 / 계산",
        badge: "신규 LIVE",
    ...
    currency: {
      title: "주요 통화 환율 변환기",
      subtitle: "제공된 최신 환율로 80개 통화를 동시에 비교하고 국가명으로 검색",
      allCurrenciesTitle: "📊 주요 국가 환율 한눈에 보기",
      selectChartNotice: "💡 수치를 직접 수정하면 현재 표시 중인 제공 환율로 모든 통화가 즉시 계산됩니다.",
  ...
  en: {
    ...
    toolsList: [
      ...
      },
      {
        ...
        desc: "Compare 80 currencies with the latest available daily rates",
    ...
    currency: {
      ...
      subtitle: "Compare 80 currencies using the latest available daily rates and search by country",
      allCurrenciesTitle: "📊 Major Exchange Rates Overview",
      selectChartNotice: "💡 Edit an amount directly to recalculate all displayed currencies with the same provided rates.",
      ...
      faq2A: "Click any quick preset button ($10, $100, 10k JPY) at the top to instantly apply that value and calculate exchange rates across all major world currencies with the same provided rates.",
  ...
  ja: {
    ...
    currency: {
      title: "多通貨為替レート計算機",
      subtitle: "最新の提供レートで80通貨を比較し、国名から検索",
      allCurrenciesTitle: "📊 主要国為替レート一覧",
      selectChartNotice: "💡 金額を直接編集すると、同じ提供レートで全ての表示通貨を再計算します。",
      ...
      faq2A: "上部のクイック入力ボタン（$100、1万円など）をクリックすると、ワンクリックで該当金額と通貨が即時適用され、表示中の主要通貨が同じ提供レートで一括計算されます。",
  ...
  zh: {
    ...
    currency: {
      title: "多币种汇率换算器",
      subtitle: "使用最新可用汇率比较80种货币，并可按国家搜索",
      allCurrenciesTitle: "📊 主要国家与地区汇率一览",
      selectChartNotice: "💡 直接修改金额，即可按同一组已提供汇率重新计算所有显示货币。",
      ...
      faq2A: "点击顶部快捷按钮（如 $100、1万日元等），即可一键应用对应金额与货币，并按同一组已提供汇率计算所有显示货币的换算数值。",
  ...
  es: {
    ...
    toolsList: [
      ...
      },
      {
        ...
        desc: "Compara 80 divisas con los últimos tipos disponibles",
        category: "Finanzas",
        badge: "NUEVO LIVE",
        path: "/currency-converter",
        isLive: true
    ...
    currency: {
      title: "Conversor de múltiples divisas",
      subtitle: "Compara 80 divisas con los últimos tipos diarios disponibles y busca por país",
      allCurrenciesTitle: "📊 Resumen de Tipos de Cambio Principales",
      selectChartNotice: "💡 Edita un importe para recalcular todas las divisas mostradas con los mismos tipos disponibles.",
