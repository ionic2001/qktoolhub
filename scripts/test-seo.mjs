...
assert.ok(koreanPixel.includes('최대 20MB·4천만 픽셀'),'Korean pixel-art initial HTML states input limits');
assert.ok(koreanPixel.includes('디더링이나 손으로 그린 도트 스프라이트를 생성하는 기능은 아닙니다.'),'Korean pixel-art initial HTML avoids unsupported features');
